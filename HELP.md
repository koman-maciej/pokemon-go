...
* The original package name 'org.pokemon.go.pokemon-go' is invalid and this project uses 'org.pokemon.go.pokemongo' instead.
...
```
$ docker run --rm pokemon-go:0.0.1-SNAPSHOT
```
